                            ...
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ $userData->name }}" type="text" name="name" id="name"
                                            placeholder="Enter Your Name" class="form-control">
                                        <p></p>
                                    </div>
                                    <div class="mb-3">
                                        <label for="email">Email</label>
                                        <input value="{{ $userData->email }}" type="text" name="email" id="email"
                                            placeholder="Enter Your Email" class="form-control">
                                        <p></p>
                                    </div>
                                    <div class="mb-3">
                                        <label for="phone">Phone</label>
                                        <input value="{{ $userData->phone }}" type="text" name="phone" id="phone"
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        ...
                        $("#phone").removeClass("is-invalid").siblings("p").html("").removeClass(
                            "invalid-feedback");
                    ...
                    if (response.status == true) {
                        ...
                        if (errors.country_id) {
                            $("#country_id").addClass("is-invalid").siblings("p").html(errors
                                .country_id).addClass("invalid-feedback");
                        } else {
