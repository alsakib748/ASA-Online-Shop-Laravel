    ...
    <div class="container">
        <div class="light-font">
            <ol class="breadcrumb primary-color mb-0">
                <li class="breadcrumb-item"><a class="white-text" href="{{ route('admin.users.index') }}">My Account</a></li>
                    ...
                    <form action="" method="post" id="changePasswordForm" name="changePasswordForm">
                        <div class="card-body p-4">
                            <div class="row">
                                ...
                                <div class="d-flex">
                                    <button id="submit" name="submit" type="submit" class="btn btn-dark">Update Password</button>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response.status == true){
                    window.location.href = "{{ route('users.changePassword') }}";
                } else{
