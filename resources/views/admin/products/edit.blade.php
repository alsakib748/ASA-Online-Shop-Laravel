...
@section('content')
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('products.index') }}" class="btn btn-primary">All Products List</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST" id="productUpdateForm"
                        ...
                        <div id="product-gallery" class="row">
                            @if ($productImages->isNotEmpty())
                                @foreach ($productImages as $image)
                                    <div class="col-md-3 col-sm-3" id="image-row-{{ $image->id }}">
                                        <div class="card">
