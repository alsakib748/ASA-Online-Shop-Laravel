						...
						<form action="" method="GET">	
							<div class="card-header">
								<div class="card-title">
									<button type="button" onclick="window.location.href='{{ route('pages.index') }}'" class="btn btn-warning btn-sm">Reset</button>
								</div>
                                    ...
                                    @if($pages->isNotEmpty())
                                        ...
                                        <tr>
											...
											<td>
												...
												<a onclick="deletePage({{ $page->id }})" href="#" class="text-danger w-4 h-4 mr-1">
