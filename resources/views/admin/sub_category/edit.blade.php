        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('sub-categories.index') }}" class="btn btn-primary">All Sub Category List</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <img src="{{ asset('uploads/subcategory/'.$subCategory->image) }}" alt="" style="max-width: 100%; height: auto; max-height: 300px; object-fit: contain;">
                                </div>
                                @endif
                            </div>
