						...
						<form action="" method="GET">	
							<div class="card-header">
								<div class="card-title">
									<button type="button" onclick="window.location.href='{{ route('brands.index') }}'" class="btn btn-warning btn-sm">Reset</button>
								</div>
                                    ...
                                    @if($brands->isNotEmpty())
                                        ...
                                        <tr>
											...
											<td>
												...
												<a onclick="deleteCategory({{ $brand->id }})" href="#" class="text-danger w-4 h-4 mr-1">
